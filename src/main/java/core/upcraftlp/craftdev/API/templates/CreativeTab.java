...
public class CreativeTab extends CreativeTabs {
	...
	/**
	 * 
	 * Used to set a Tab's display icon. use null to display a random ITem from the Tab's item list.
	 * <p></p>
	...
	public void setIconStack(ItemStack icon) {
		...
		{
			this.icon = new ItemStack(Items.BIRCH_BOAT);
			CraftDevCore.getLogger().println("Tried to register a null value as Item for a CreativeTab, defaulting to " + Items.APPLE.getRegistryName());
