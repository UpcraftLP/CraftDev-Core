            ...
            if ( IForgeRegistryEntry.class.isAssignableFrom(f.getType()) ) {
                try {
                    ...
                    if ( entry instanceof Item ) {
                        ...
                        if ( block instanceof core.upcraftlp.craftdev.API.templates.Block ) {
                ...
                if ( !Modifier.isFinal(f.getModifiers()) )
                    CraftDevCore.getLogger().println(clazz.getName() + ":" + f.getName() + " has no final modifier! Pleaes change this!");
            }
        }
