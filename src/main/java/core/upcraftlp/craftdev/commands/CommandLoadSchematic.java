...
public class CommandLoadSchematic extends CommandBase implements ICommand {
    ...
    public List<String> getTabCompletions(MinecraftServer server, ICommandSender sender, String[] args, BlockPos targetPos) {
        ...
        if(args.length == 6) return getListOfStringsMatchingLastWord(args, "0", "90", "180", "270");
        if(args.length == 7) return getListOfStringsMatchingLastWord(args, "true", "false");
